...
set_property PACKAGE_PIN Y18 [get_ports cmos_rst_n]
set_property IOSTANDARD LVCMOS33 [get_ports cmos_rst_n]
set_property PACKAGE_PIN V12 [get_ports cmos_href]
set_property PACKAGE_PIN Y14 [get_ports cmos_pclk]
set_property PACKAGE_PIN U18 [get_ports cmos_pwdn]
set_property PACKAGE_PIN T11 [get_ports cmos_vsync]
...
set_property PACKAGE_PIN W14 [get_ports {cmos_data[7]}]
set_property PACKAGE_PIN V16 [get_ports {cmos_data[6]}]
set_property PACKAGE_PIN Y17 [get_ports {cmos_data[5]}]
set_property PACKAGE_PIN W19 [get_ports {cmos_data[4]}]
set_property PACKAGE_PIN Y16 [get_ports {cmos_data[3]}]
set_property PACKAGE_PIN W18 [get_ports {cmos_data[2]}]
set_property PACKAGE_PIN Y19 [get_ports {cmos_data[1]}]
set_property PACKAGE_PIN U19 [get_ports {cmos_data[0]}]
